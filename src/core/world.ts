...
export class World {
  ...
  async initialize(): Promise<void> {
    ...
    this.updateComponent(this.#debugEntity, new TransformComponent(Vec2.create()));
  ...
  *queryByLayer(
  ...
  getCamera(): QueryItem<[typeof Camera, typeof TransformComponent]> | undefined {
    const iterator = this.query(Camera, TransformComponent).next();
    return iterator.done ? undefined : iterator.value;
  }

  getPlayer(): QueryItem<[typeof TransformComponent, typeof PlayerComponent]> | undefined {
