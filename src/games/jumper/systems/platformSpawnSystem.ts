...
import { COIN_SIZE, createCoin } from "@/games/jumper/entities/coin";
import {
	ROCKET_BOOSTER_SIZE,
	createRocketBooster,
} from "@/games/jumper/entities/rocketBooster";
import type { Entity } from "@/entities/entity";
import { type PlatformKind } from "@/games/jumper/components/platformComponent";
...
export class PlatformSpawnSystem implements JumperSystem {
	#hardness: () => number;
	#random: Random;
	#randomSize: Random;
	#randomRocket: Random;
