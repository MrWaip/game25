...
export const upgradeBadges: Record<Upgrade, string> = {
	charge: "ПЯТОЕ ПОПАДАНИЕ → МОЛНИИ",
	acidBurst: "КИСЛОТНЫЕ ВЗРЫВЫ",
	execution: "ДОБИВАНИЕ",
	soulHarvest: "УБИЙСТВА НАКАПЛИВАЮТ СИЛУ",
	solitude: "СИЛА ОДИНОЧНОЙ БАШНИ",
	auraPower: "АУРА УСИЛИВАЕТ УРОН",
	overdriveEcho: "ФОРСАЖ ВЗРЫВАЕТ ЦЕЛИ",
	crossfire: "ЧЕРЕДОВАНИЕ ТИПОВ УРОНА",
	reserve: "МОНЕТЫ ЗА СДЕРЖАННОСТЬ",
